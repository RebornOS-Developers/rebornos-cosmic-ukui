...
# Added Rhytmbox for music playback
# Added dconf-editor
...
arch=('any')
license=('GPL3')
depends=('indicator-china-weather' 'kylin-nm' 'qt5-ukui-platformtheme' 'ukui-biometric-auth' 
...
'peony-extensions' 'partitionmanager' 'rhythmbox' 'dconf-editor')
